...
const Page = ({params:{slug}}:{params:{slug:string}}) => {
  ...
  return (
    <div>
      <header className="mb-6 pb-4"><h1 className="mb-2 text-4xl font-extrabold">{blog.metadata.title}</h1>
        <time className="text-sm opacity-70" dateTime="2021-05-03 22:00">{formatDate(blog.metadata.publishedAt)}</time>
