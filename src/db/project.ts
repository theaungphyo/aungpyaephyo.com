export const projects = [
  ...
  },
  {
    ...
    skills: 'Typescript,Next.js,NextAuth,Zod,ReactHookForm,ShadcnUI',
  ...
  },
  {
    ...
    title: 'MM Pad',
    description:
      'Developed the MMPad at Myanmar Media Linkage Company Limited in 2023. The project, built with Tailwindcss, RadixUI, NextJS, Zod, ReactHookForm, Zustand, NextAuth, Inspired by Wattpad',
    demo: '',
